...
from my_utils.sparsify import sparsify_weights, sparsify_units, sparsify_vgg_weights
...
def expt_main():
  ...
  for layer_type in layer_types:
    ...
    for ki, k in enumerate(sparse_k_levels):
      ...
      model_sparse = sparsify_vgg_weights(model, sparsity_k=k, layer_type=layer_type)
