...
from my_utils.nsd_dataset import get_tripleN_reliability
...
def compute_linear_predictivity(X, Y, k_folds=5):
  ...
  n_samples = X.shape[0]
  results = {}
  neuron_reliability = get_tripleN_reliability("/home/nirajesh/untrained_pred/neural_data/tripleN/filtered_units_by_roi_all.csv")
